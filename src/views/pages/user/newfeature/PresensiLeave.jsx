...
import '../../../css/PresensiHome.css'; // Pastikan CSS yang sama digunakan
...
const PresensiLeave = () => {
  ...
  return (
    <div className="presensi-container"> {/* Menggunakan class yang sama */}
      <h2>Presensi Berangkat</h2> {/* Pastikan ini sama */}
      <form className="presensi-form" onSubmit={handleSubmit}> {/* Class form yang sama */}
        ...
        <input
          ...
          required
        />
        <button className="submit-btn" type="submit">Submit</button> {/* Tombol submit yang sama */}
      </form>
