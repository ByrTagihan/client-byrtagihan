  ...
  const get = async () => {
    try {
      const { data, status } = await axios.get(
        `${API_DUMMY}/user/member?page=${currentPage}&limit=${limit}&sortBy=${sortBy}&sortDirection=${sortDirection}&search=${searchTerm}`,
        {
        ...
        <CCardHeader>
          <div className="d-flex justify-content-between">
            ...
            >
              <div>
                <CFormInput
                  className="search-siswa inputSearch"
                  type="search"
              ...
              <CButton className="tambah" onClick={() => setVisible(!visible)}>
                <CIcon icon={cilPlus} />
                Tambah
              </CButton>
            </div>
              ...
              {filteredMembers.map((mem, index) => {
                return (
                  <CTableRow key={index}>
                    ...
                    <CTableDataCell data-cell="Nama">{mem.name}</CTableDataCell>
                    ...
                    <CTableDataCell data-cell="Action">
                      ...
                      <CButton
                        ...
                        className="hapus btn btn-danger"
                      >
